        ...
        <div className={classes.main}>
            ...
            <div className={classes.content}>
                ...
                <div className={classes.middle__section}>
                    <p>
                        { !isLoading ? orderDetail && orderDetail.code
                          ? orderDetail.code
                          : '\u00A0'
                          : 'loading...' }
                    </p>
                    <p>
                        { !isLoading ? orderDetail && orderDetail.create_at
                          ? new Date(orderDetail.create_at).toLocaleString('vi', { timeZone: 'Asia/Ho_Chi_Minh' })
                          : '\u00A0'
                          : 'loading...' }
                    </p>
                    <p>
                        { !isLoading ? orderDetail && orderDetail.service
                          ? orderDetail.service
                          : '\u00A0'
                          : 'loading...' }
                    </p>
                    <p style={{ color: '#666666' }}>
                        { !isLoading ? orderDetail && orderDetail.paymentDelivery !== undefined
                    ...
                    >
                        { !isLoading ? orderDetail && orderDetail.status
                          ? orderDetail.status
                          : '\u00A0'
                          : 'loading...' }
                    </p>
            ...
            <div className={classes.price__section__container}>
                ...
                <div className={classes.price__middle__section}>
                    <p>
                        { !isLoading ? orderDetail && orderDetail.totalPrice
