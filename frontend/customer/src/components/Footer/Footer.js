    ...
    <div className={classes['footer-wrap']}>
        <div className={classes.footer}>
            ...
            <div className={classes.footer__introduction}>
                ...
                <p className={classes['footer__introduction-content']}>
                    Nếu bạn là người bán hãy thoải mái cùng ATM CLOTHING giải phóng không gian, trao cho đồ đạc của mình
                    một cuộc đời mới.
                </p>
                <p className={classes['footer__introduction-content']}>
                ...
                <p className={classes['footer__introduction-content']}>
                    Hãy để ATM Clothing đồng hành cùng các bạn trên hành trình xây dựng lối sống xanh, sạch, bền vững
                    nhé!
                </p>
            </div>
