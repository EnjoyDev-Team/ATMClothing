                        ...
                        className={`${classes.dot}${
                            index <= step
                                ? step !== progressions.length - 1 && index === step
                                    ? ` ${classes.inprogress}`
                                    : ` ${step === index && index === progressions.length - 1 && !success ? classes.fail : classes.active}`
                                : ''
                        }`}
                    >
                        {index < step || step === progressions.length - 1 ? (
                            <FontAwesomeIcon icon={(step === index && index === progressions.length - 1 && !success) ? faXmark : faCheck} />
                        ) : (
                            index + 1
                        )}
                    </div>
